...
public class Vacante {
	...
	private Integer id;
	private String nombre; //nombre e laoferta de trabajo
	private String descripcion; //desc deltrabajo
	private LocalDate fecha = LocalDate.now(); //fecha de publicacion de oferta
	...
	//@Transient //para descartas la relacion porque de momento no se tiene completo
